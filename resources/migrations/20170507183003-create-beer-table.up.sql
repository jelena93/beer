 CREATE TABLE IF NOT EXISTS beer (
  ...
  PRIMARY KEY (id),
  FOREIGN KEY (style) REFERENCES beer_style(id) ON UPDATE CASCADE ON DELETE CASCADE
);
--;;
INSERT INTO beer
...
(71, 'Kozel Černy', 0, 1, 12, '3,8%', 'Pivovar Velké Popovice (SAB Miller)', 'Češka', 'http://www.ratebeer.com/beer/kozel-cerny-dark-10o/390/'),
...
(109, 'Crow Dr Jekyll', 1, 0, 5, '3,8%', 'Crow Brewery', 'Srbija', 'https://www.ratebeer.com/beer/crow-dr-jekyll/379123/'),
